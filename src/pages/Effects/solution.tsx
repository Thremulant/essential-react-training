...
export const EffectsSolution = () => {
    ...
    // Every render independent of what triggered. There's no scenario where we want that to happen
    // useEffect(() => {
    //     console.log(`not this... ${renderCount}`)
    ...
    useEffect(() => {
        ...
        switch (counter) {
            case 10:
                setCounterText('Good start')
                break;
            case 20:
                setCounterText(`You've got 20!`)
                break;
            case 30:
                setCounterText('¯\\_(ツ)_/¯')
                break;
            default:
                break;
        }
